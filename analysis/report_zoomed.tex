...
\title{RankAlign Training Dynamics Analysis (Zoomed Loss Curves)\\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/wandb_loss_methods_gemma-9b-it_ifeval_zoomed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/wandb_loss_tc_gemma-9b-it_ifeval_zoomed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{{plots/wandb_loss_methods_qwen3.5-9b_ifeval_zoomed}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{{plots/wandb_loss_tc_qwen3.5-9b_ifeval_zoomed}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{{plots/wandb_loss_methods_qwen3.5-9b_membership_zoomed}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{{plots/wandb_loss_tc_qwen3.5-9b_membership_zoomed}.png}
...
\caption{Score spread evolution during training. s2 on Gemma IFEval shows unbounded generator score growth.}
\label{fig:score_evolution}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{plots/wandb_preference_loss_evolution.png}
\caption{Preference loss evolution. All constrained settings converge; s2 achieves low preference loss at the cost of NLL explosion.}
\label{fig:pref_loss}
\end{figure}
