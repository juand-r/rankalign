# Persona-v0 trained-model results

All cells: **mean (std) across the 8 persona-v0-<slug> test tasks, x 100**.
All eval jobs used `--base-typcorr` (typicality reference = base instruct model).
...
## gemma-2-9b-it  Generator ROC-AUC  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Validator ROC-AUC  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Validator accuracy (threshold 0)  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Pearson(gen_score, val_score)  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Generator ROC-AUC  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Validator ROC-AUC  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Validator accuracy (threshold 0)  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-9b-it  Pearson(gen_score, val_score)  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Generator ROC-AUC  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Validator ROC-AUC  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Validator accuracy (threshold 0)  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Pearson(gen_score, val_score)  (eval flags: `--self-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Generator ROC-AUC  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Validator ROC-AUC  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Validator accuracy (threshold 0)  (eval flags: `--neg-typcorr --base-typcorr`)
...
## gemma-2-2b-it  Pearson(gen_score, val_score)  (eval flags: `--neg-typcorr --base-typcorr`)
