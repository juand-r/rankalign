#!/bin/bash
# Eval runs for the finetuned neg-typicality models (epoch 2).
# All use eval_by_claude.py with --neg-typicality --validator-log-odds.
# Mirrors semi_supervised_eval_runs*.sh but for tc-neg models.
#
...
MP=../models/v6-google--gemma-2-2b-delta0.15-epoch2--plausibleqa-all--d2g--random--alpha1.0--tc-neg

# --- pref-only labelonly (no vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--force-same-x--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_PQA

# --- pref-only labelonly (vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_PQA

# --- pref-only semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_PQA

# --- comb labelonly ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_PQA

# --- comb semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--semi0.1 --neg-typcorr --log-odds -- $TASKS_PQA

# --- sft semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MP--full-completion--pref0.0--nllv1.0--nllg1.0--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_PQA
...
MA=../models/v6-google--gemma-2-2b-delta0.15-epoch2--ambigqa-all--d2g--random--alpha1.0--tc-neg

# --- pref-only labelonly (no vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--force-same-x--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_AQA

# --- pref-only labelonly (vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_AQA

# --- pref-only semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_AQA

# --- comb labelonly ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_AQA

# --- comb semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--semi0.1 --neg-typcorr --log-odds -- $TASKS_AQA

# --- sft semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MA--full-completion--pref0.0--nllv1.0--nllg1.0--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_AQA
...
MH=../models/v6-google--gemma-2-2b-delta0.15-epoch2--hypernym-concat-bananas-to-dogs-double-all--d2g--random--alpha1.0--tc-neg

# --- pref-only labelonly (no vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--force-same-x--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_HYP

# --- pref-only labelonly (vallogodds) ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_HYP

# --- pref-only semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_HYP

# --- comb labelonly ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds -- $TASKS_HYP

# --- comb semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--semi0.1 --neg-typcorr --log-odds -- $TASKS_HYP

# --- sft semi ---
run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MH--full-completion--pref0.0--nllv1.0--nllg1.0--force-same-x--semi0.1 --neg-typcorr --log-odds -- $TASKS_HYP
...
# MI=../models/v6-google--gemma-2-2b-delta0.15-epoch2--ifeval-concat-all--d2g--random--alpha1.0--tc-neg
#
# # --- pref-only labelonly (no vallogodds) ---
# run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MI--full-completion--force-same-x--labelonly0.1 --neg-typcorr --log-odds --disc-shots-zero -- $TASKS_IFE
#
# # --- pref-only labelonly (vallogodds) ---
# run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MI--full-completion--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds --disc-shots-zero -- $TASKS_IFE
#
# # --- comb labelonly ---
# run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MI--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--labelonly0.1 --neg-typcorr --log-odds --disc-shots-zero -- $TASKS_IFE
#
# # --- comb semi ---
# run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MI--full-completion--nllv1.0--nllg1.0--force-same-x--vallogodds--semi0.1 --neg-typcorr --log-odds --disc-shots-zero -- $TASKS_IFE
#
# # --- sft semi ---
# run 1 2 --cpu 4 --mem 32G scripts/run_eval_semi.sh $MI--full-completion--pref0.0--nllv1.0--nllg1.0--force-same-x--semi0.1 --neg-typcorr --log-odds --disc-shots-zero -- $TASKS_IFE
