#!/usr/bin/env python3
"""Save humaneval correct-multi v7 tables as a markdown snapshot in docs/."""
...
BUILDER = REPO / "scripts/_build_humaneval_cm_v7_table.py"
DOCS = REPO / "docs"
...
lines = [
    f"# humaneval-v2.1correct-multi × gemma-4-31B-it — v7 epoch2 tables",
    f"",
    f"Snapshot: **{timestamp}**",
    f"",
    f"Model: gemma-4-31B-it, trained on humaneval-v2.1correct-multi-all, epoch 2.",
    ...
    f"",
    f"To refresh: `python scripts/_save_cm_v7_tables_md.py`",
    f"",
]
...
out_path = DOCS / f"humaneval_cm_v7_tables_{date_str}.md"
out_path.write_text("\n".join(lines) + "\n")
