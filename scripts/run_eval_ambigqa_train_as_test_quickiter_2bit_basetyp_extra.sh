#!/bin/bash
# Extra basetyp / basetypneg evals for the gemma-2-2b-IT
# ambigqa-train-as-test quick-iter models. Mirror of
# run_eval_ambigqa_train_as_test_quickiter_basetyp_extra.sh, swapping in
# the gemma-2-2b-it base model and checkpoint prefix.
#
# All eval calls pass --validator-log-odds.
#
# Usage:
#   run 1 2 bash scripts/run_eval_ambigqa_train_as_test_quickiter_2bit_basetyp_extra.sh
...
PREFIX="v6-google--gemma-2-2b-it-delta0.15-epoch${EPOCH}--${TASK}-all--d2g--random--alpha1.0"
