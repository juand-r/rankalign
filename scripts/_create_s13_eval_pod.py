...
# pandas==3.0.3, which requires >=3.11). This is the image recommended in
# docs/gemma4-31b-pod-setup.md for fresh gemma-4 pods.
IMAGE = "runpod/pytorch:1.0.3-cu1290-torch280-ubuntu2404"  # torch 2.8, CUDA 12.9
