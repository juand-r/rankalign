...
def analyze_correlations(df, outputs_dir):
    ...
    plt.tight_layout()
    plt.savefig(str(Path(outputs_dir) / 'length_correlation_matrix.png'), dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nSaved: length_correlation_matrix.png")
...
def analyze_redundancy(df, outputs_dir):
    ...
    plt.tight_layout()
    plt.savefig(str(Path(outputs_dir) / 'length_redundancy_analysis.png'),
                dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nSaved: length_redundancy_analysis.png")
...
def grid_search_alpha_c(df, outputs_dir):
    ...
    plt.tight_layout()
    plt.savefig(str(Path(outputs_dir) / 'length_grid_search_heatmap.png'),
                dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nSaved: length_grid_search_heatmap.png")
...
def analyze_per_prompt_length(df, outputs_dir):
    ...
    plt.tight_layout()
    plt.savefig(str(Path(outputs_dir) / 'length_per_prompt_analysis.png'),
                dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nSaved: length_per_prompt_analysis.png")
