#!/bin/bash
# Evaluate the 6 pref-only semi 0.1 trained models (epoch 1).
...
run 1 3 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--plausibleqa-all--d2g--random--alpha1.0--full-completion--force-same-x--semi0.1 \
...
# ============================================================
run 1 3 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--plausibleqa-all--d2g--random--alpha1.0--tc-self--full-completion--force-same-x--semi0.1 \
    --self-typcorr --log-odds -- \
    plausibleqa-nq_1114 plausibleqa-nq_1324 plausibleqa-nq_1328 plausibleqa-nq_1369 \
    plausibleqa-nq_1394 plausibleqa-nq_1438 plausibleqa-nq_1663 plausibleqa-nq_2031 \
    plausibleqa-nq_207 plausibleqa-nq_2174 plausibleqa-nq_2281 plausibleqa-nq_2421 \
...
run 1 1 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--ambigqa-all--d2g--random--alpha1.0--full-completion--force-same-x--semi0.1 \
    --self-typcorr --log-odds -- \
...
# ============================================================
run 1 1 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--ambigqa-all--d2g--random--alpha1.0--tc-self--full-completion--force-same-x--semi0.1 \
    --self-typcorr --log-odds -- \
    ambigqa-american ambigqa-danube ambigqa-executed ambigqa-gives \
    ambigqa-harry ambigqa-involved ambigqa-jack ambigqa-plays \
    ambigqa-received ambigqa-sang ambigqa-soccer ambigqa-used \
...
run 1 0 --min 30 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--hypernym-concat-bananas-to-dogs-double-all--d2g--random--alpha1.0--full-completion--force-same-x--semi0.1 \
    --self-typcorr --log-odds -- \
...
# ============================================================
run 1 0 --min 30 scripts/run_eval_semi.sh \
    $MODELS/v6-google--gemma-2-2b-delta0.15-epoch1--hypernym-concat-bananas-to-dogs-double-all--d2g--random--alpha1.0--tc-self--full-completion--force-same-x--semi0.1 \
    --self-typcorr --log-odds -- \
    hypernym-bananas hypernym-bazookas hypernym-cabinets hypernym-cars \
    hypernym-chairs hypernym-crows hypernym-diapers hypernym-dogs \
    hypernym-dolls hypernym-ducklings hypernym-elephants hypernym-guns \
