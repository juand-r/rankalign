#!/bin/bash
# Cross-comparable basetyp/basetypneg evals for the gemma-2-2b-IT
# rosch-furniture-and-bird models. Mirror of
# run_eval_rosch_online_quickiter_basetyp_extra.sh; only BASE_MODEL and the
# checkpoint PREFIX change.
#
# All eval calls pass --validator-log-odds.
#
# Usage:
#   run 1 1 bash scripts/run_eval_rosch_online_quickiter_2bit_basetyp_extra.sh
