...
#
# Usage: run 1 <hours> scripts/run_train_plausibleqa_v0.sh <TASK> <MODE> <LOSS> [--typcorr] [--self-typcorr] [--lenorm] [--log-odds]
#
# Arguments:
...
#   --typcorr      Optional: enable GPT-2 typicality correction (ignored when MODE=all)
#   --self-typcorr Optional: enable self-typicality correction (model as its own prior)
#   --lenorm       Optional: enable length normalization for generator scores
#   --log-odds     Optional: enable validator log-odds (log(P(Yes)/P(No)))
#
# Examples:
