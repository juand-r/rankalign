#!/bin/bash
# Matched-eval script for the gemma-2-2b-IT ambigqa-train-as-test models.
# Mirror of run_eval_ambigqa_train_as_test_quickiter.sh; only BASE_MODEL and
# the checkpoint PREFIX change.
#
# All eval calls pass --validator-log-odds.
#
# Usage:
#   run 1 4 bash scripts/run_eval_ambigqa_train_as_test_quickiter_2bit.sh
