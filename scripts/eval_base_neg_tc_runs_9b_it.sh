#!/bin/bash
# Base model (google/gemma-2-9b-it) evaluation with neg-typicality correction (LLR).
...
# ============================================================
run 1 4 scripts/run_eval_semi.sh $MODEL --neg-typcorr --log-odds -- \
...
# ============================================================
run 1 4 scripts/run_eval_semi.sh $MODEL --neg-typcorr --log-odds --disc-shots-zero -- \
