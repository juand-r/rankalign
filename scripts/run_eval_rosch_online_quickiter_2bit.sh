#!/bin/bash
# Matched-eval script for the gemma-2-2b-IT quick-iter rosch-furniture-and-bird
# models. Mirror of run_eval_rosch_online_quickiter.sh; only BASE_MODEL and the
# checkpoint PREFIX change.
#
# All eval calls pass --validator-log-odds.
#
# Usage:
#   run 1 3 bash scripts/run_eval_rosch_online_quickiter_2bit.sh
...
# Same per-variant TC convention as the bare-2b script.
declare -A EVAL_TC
